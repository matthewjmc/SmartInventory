...
<template>
    <div>
        ...
        <div class='outer-container'>
            ...
            <div class='buttonGroup'>
                    <div class="square">
                        ...
                        <a class='loginButton' href="https://iot2.mcmullin.org/withdraw">WITHDRAW</a>
                        <a class='loginButton' href="https://iot2.mcmullin.org/deposit">DEPOSIT</a>
                        <a class='currentButton'>RENTAL</a>
                    </div>
            </div>
        </div>
        ...
        <div class="items-container">
            ...
            <Items v-for="item in items" :key="item.item_name" 
        ...
        async created(){
          ...
          try {
            const res = await axios.get(
              'https://api.iot2.mcmullin.org/api/inventory',config);
